...
_G.packer_plugins = {
  ["alpha-nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/opt/alpha-nvim"
  },
  ["bufferline.nvim"] = {
  ...
  ["cmp-treesitter"] = {
    after_files = { "/home/ubuntu/.local/share/nvim/site/pack/packer/opt/cmp-treesitter/after/plugin/cmp_treesitter.lua" },
    loaded = false,
    needs_bufread = false,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/opt/cmp-treesitter"
  },
  ["cmp-vsnip"] = {
  ...
  ["indent-blankline.nvim"] = {
    config = { "\27LJ\2\n˝\2\0\0\4\0\n\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\0025\3\6\0=\3\a\0025\3\b\0=\3\t\2B\0\2\1K\0\1\0\21context_patterns\1\b\0\0\nwhile\aif\bfor\vmethod\rfunction\nclass\vstruct\21filetype_exclude\1\6\0\0\thelp\nalpha\vpacker\17neogitstatus\rNvimTree\20buftype_exclude\1\3\0\0\rterminal\14telescope\1\0\6\19use_treesitter\2\25show_current_context\2\17indent_level\3\4#show_trailing_blankline_indent\1\21show_end_of_line\1\25space_char_blankline\5\nsetup\21indent_blankline\frequire\0" },
    loaded = true,
  ...
  kommentary = {
    loaded = true,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/start/kommentary"
  },
  ["lsp-trouble.nvim"] = {
    commands = { "LspTrouble" },
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/opt/lsp-trouble.nvim"
  },
  ["lualine.nvim"] = {
  ...
  ["null-ls.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/ubuntu/.local/share/nvim/site/pack/packer/opt/null-ls.nvim"
  },
  ["nvim-autopairs"] = {
    loaded = true,
  ...
  ["nvim-tree.lua"] = {
    commands = { "NvimTree*" },
    config = { "\27LJ\2\nï\1\0\0\3\0\a\0\v6\0\0\0009\0\1\0+\1\2\0=\1\2\0006\0\0\0009\0\1\0005\1\5\0005\2\4\0=\2\6\1=\1\3\0K\0\1\0\blsp\1\0\0\1\0\4\thint\bÔÉ´\tinfo\bÔÅö\nerror\b‚úó\fwarning\bÔÅ±\20nvim_tree_icons\30nvim_tree_lsp_diagnostics\6g\bvim\0" },
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-cmp', 'null-ls.nvim', 'vim-vsnip', 'cmp-path', 'cmp-buffer', 'nvim-lspconfig', 'cmp-nvim-lsp', 'nvim-lspinstall', 'cmp-treesitter', 'cmp-nvim-lua', 'cmp-vsnip'}, { ft = "lua" }, _G.packer_plugins)]]
vim.cmd [[au FileType cpp ++once lua require("packer.load")({'nvim-cmp', 'vim-vsnip', 'cmp-path', 'cmp-buffer', 'nvim-lspconfig', 'cmp-nvim-lsp', 'nvim-lspinstall', 'cmp-treesitter', 'cmp-nvim-lua', 'cmp-vsnip'}, { ft = "cpp" }, _G.packer_plugins)]]
vim.cmd [[au FileType c ++once lua require("packer.load")({'nvim-cmp', 'vim-vsnip', 'cmp-path', 'cmp-buffer', 'nvim-lspconfig', 'cmp-nvim-lsp', 'nvim-lspinstall', 'cmp-treesitter', 'cmp-nvim-lua', 'cmp-vsnip'}, { ft = "c" }, _G.packer_plugins)]]
